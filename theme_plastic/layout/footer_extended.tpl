                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h5 class="title">LIÊN HỆ NHANH</h5>
                                </div>
                                <div class="icon-bx-wraper style-2 m-b20">
                                    ...
                                    <div class="icon-content">
                                        <p>C7A/3C/2 Đường Võ Văn Vân, ấp 3, Xã Vĩnh Lộc B, Huyện Bình Chánh, TP Hồ Chí Minh</p>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row align-items-center fb-inner spno">
                        <div class="col-12 text-center">
                            <span class="copyright-text">Copyright © 2024 <a href="" class="text-primary" target="_blank">DACLOI</a> All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </div>
